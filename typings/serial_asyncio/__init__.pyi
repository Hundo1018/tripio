...
async def create_serial_connection(loop, protocol_factory, *args, **kwargs): # -> tuple[SerialTransport, Any]:
...
async def connection_for_serial(loop, protocol_factory, serial_instance): # -> tuple[SerialTransport, Any]:
